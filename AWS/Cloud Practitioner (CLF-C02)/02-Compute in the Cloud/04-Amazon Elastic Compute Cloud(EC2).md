...
- Convertible Reserved Instances: If you need to run your EC2 instances in different [08B-Availability Zones](AWS/Cloud%20Practitioner%20(CLF-C02)/03-Infrastructure%20and%20Realiability/08B-Availability%20Zones.md) or different instance types, then Convertible Reserved Instances might be right for you.
...
> [!IMPORTANT] Amazon EC2 Auto Scaling
